...
NB_CPUS = 16
ENGLISH_WORDS_PATH = r"reduced_words_list.txt"
...
class Wordle_grid:
    ...
    def analyse_wordle_grid(self):
        ...
        quadruple_letters = []
        quintuple_letters = []
        # letters whose exact number of occurences has been identified
        ...
        for attempt_index, attempt in enumerate(self.attempts_list):
            for letter_index, letter in enumerate(attempt):
                ...
                if self.colors_list[attempt_index][
                    letter_index] == 'x' and nb_colored == 0 and letter in remaining_letters:
...
if __name__ == "__main__":
    attempts_list = ['raise', 'would', 'melon']
    colors_list = ['xxxxy', 'xyxyx', 'ygygg']
